...
namespace Shooter2D.Enemy
{
    public class EnemyService
    {
        ...
        public EnemyService(EnemyView enemyPrefab, EnemySO enemyScriptableObject)
        {
            this.enemyScriptableObject = enemyScriptableObject;
            enemyPool = new EnemyPool(enemyPrefab, enemyScriptableObject, this);
            InitializeVariables();
        }
        ...
        private void SpawnEnemy()
        {
            ...
            EnemyOrientation randomOrientation = (EnemyOrientation)UnityEngine.Random.Range(0, Enum.GetValues(typeof(EnemyOrientation)).Length);
        ...
        private Vector2 CalculateSpawnPosition(EnemyOrientation enemyOrientation)
        {
            ...
            switch (enemyOrientation)
            {
                case EnemyOrientation.Left:
                    ...
                    spawnPosition.y = UnityEngine.Random.Range(-halfScreenHeight, halfScreenHeight);
                    break;
                ...
                case EnemyOrientation.Up:
                    spawnPosition.x = UnityEngine.Random.Range(-halfScreenWidth, halfScreenWidth);
